    ...
    <>
      <div className="w-64 bg-white p-">
        ...
        <div className="flex flex-col gap-2 p-2">
          <Button className="justify-start" variant={pathname === "/" ? "secondary" : "ghost"} asChild>
            <Link href="/" className="flex items-center gap-2">
              <LayoutGrid size={20} /> Dashboard
            </Link>
          </Button>
          <Button className="justify-start" variant={pathname === "/products" ? "secondary" : "ghost"} asChild>
            <Link href="/products" className="flex items-center gap-2">
              <PackageIcon size={20} /> Products
            </Link>
          </Button>
          <Button className="justify-start" variant={pathname === "/sales" ? "secondary" : "ghost"} asChild>
